...
childelm.innerHTML = "My name is fayyaz"
console.log(childelm);

let tridelm1 = document.getElementById("main");
let childelm2 = tridelm1.lastElementChild;
childelm2.innerHTML = "My name is fayyaz"
...
prisib.innerHTML = "Hello brother"
console.log(prisib)

let siblling1 = document.getElementById("four");
let prisib2 = siblling1.nextElementSibling;
prisib2.innerHTML = "Hello sister"
console.log(prisib2)